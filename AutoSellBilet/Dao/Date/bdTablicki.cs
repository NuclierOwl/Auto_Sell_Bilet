...
namespace AutoSellBilet.Dao.Date;

public partial class bdTablicki : DbContext
{
    public bdTablicki()
    {
    }

    public bdTablicki(DbContextOptions<bdTablicki> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bron>(entity =>
        {
            ...
            entity.HasOne(d => d.FilmNavigation).WithMany()
                .HasForeignKey(d => d.Film)
                .HasConstraintName("bron_film_fkey");

            entity.HasOne(d => d.ZritelNavigation).WithMany()
